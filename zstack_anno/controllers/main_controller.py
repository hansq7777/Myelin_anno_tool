...
class MainController(QMainWindow, FileOpsMixin, MorphologyMixin, ScriptMixin):
    ...
    def _create_menu(self):
        ...
        ridge_act = linear_menu.addAction("OpenCV Ridge")
        ...
        chan_act = linear_menu.addAction("Chan-Vese")
        ...
        tube_act = linear_menu.addAction("TubeTK Tubes")
        tube_act.triggered.connect(lambda: self.script_tubetk_segment())
        seed_act = linear_menu.addAction("TubeTK Seed Path")
        seed_act.triggered.connect(lambda: self.script_tubetk_seed_path())
        hess_act = linear_menu.addAction("Hessian Filter")
        ...
        cvgab_act = linear_menu.addAction("OpenCV Gabor")
        cvgab_act.triggered.connect(lambda: self.script_cv_gabor_filter())
        st_act = linear_menu.addAction("Structure Tensor")
