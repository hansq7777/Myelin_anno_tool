...
- [ ] MplCanvas.__init__
- [ ] ZStackAnnotationTool.__init__
- [ ] ZStackAnnotationTool.keyPressEvent
- [ ] ZStackAnnotationTool.push_undo_stack
- [ ] ZStackAnnotationTool.undo_last_operation
- [ ] ZStackAnnotationTool.redo_operation
- [ ] ZStackAnnotationTool.prev_slice
- [ ] ZStackAnnotationTool.next_slice
- [ ] ZStackAnnotationTool.closeEvent
- [ ] ZStackAnnotationTool._on_close_window
- [ ] ZStackAnnotationTool.choose_annotation_folder
- [ ] ZStackAnnotationTool.choose_image_file
- [ ] ZStackAnnotationTool.choose_annotation_files
- [ ] ZStackAnnotationTool.load_data
- [ ] ZStackAnnotationTool.close_current
- [ ] ZStackAnnotationTool.on_slice_changed
- [ ] ZStackAnnotationTool.update_display
- [ ] ZStackAnnotationTool._extract_slice
- [ ] ZStackAnnotationTool._normalize_to_8bit
- [ ] ZStackAnnotationTool.apply_filter_current_slice
- [ ] ZStackAnnotationTool.erode_current_slice
- [ ] ZStackAnnotationTool.dilate_current_slice
- [ ] ZStackAnnotationTool.remove_bg_pixels_current_slice
- [ ] ZStackAnnotationTool.apply_stretch
- [ ] ZStackAnnotationTool.reset_stretch
- [ ] ZStackAnnotationTool.toggle_select_mode
- [ ] ZStackAnnotationTool._delete_single_area
- [ ] ZStackAnnotationTool._delete_areas_in_rect
- [ ] ZStackAnnotationTool.on_mouse_press
- [ ] ZStackAnnotationTool.on_mouse_release
- [ ] ZStackAnnotationTool.on_mouse_move
- [ ] ZStackAnnotationTool.on_scroll
- [ ] ZStackAnnotationTool.update_masks
- [ ] ZStackAnnotationTool.save_annotation
- [ ] ZStackAnnotationTool.random_seeds_current_slice
- [ ] ZStackAnnotationTool.gradient_expand_current_slice
- [ ] main
