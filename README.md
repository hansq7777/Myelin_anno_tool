...
junctions and keeps only elongated segments. Two quick checks for 2D and 3D
linearity using skeleton length ratios are also available. The **Image** menu provides histogram stretch
